    ...
    <div className="bg-[#f1f5f9] min-h-screen flex flex-col font-sans select-none">
      ...
      >
        ...
        <div id="medicine" className="p-[15px] sm:p-6 md:p-[30px_40px] lg:p-[30px_70px] flex flex-col items-start gap-2.5">
          <h1 className="text-black text-[30px] sm:text-[35px] w-[260px] md:w-full font-bold leading-tight">
            Welcome to Medicine finder
          </h1>
          <p className="text-gray-500 text-[15px] sm:text-[20px]">
            Find Generic & Alternative Medicine Easily
          </p>
          <Link 
            to="/find"
            className="text-[12px] sm:text-[15px] md:text-[18px] p-[5px_10px] md:p-[8px_20px] color-white text-white bg-blue-600 rounded-[10px] md:rounded-full inline-block transition-transform duration-300 hover:scale-[1.02]"
          >
            🔍 Find Your Medicine
          </Link>
        </div>
